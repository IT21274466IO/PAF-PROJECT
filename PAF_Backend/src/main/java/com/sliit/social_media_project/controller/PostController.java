...
import com.sliit.social_media_project.response.ApiResponse;
import com.sliit.social_media_project.service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<Post> createPost(@RequestHeader("Authorization") String jwt ,@RequestBody Post post) throws Exception {
        ...
        Post creadPost = postService.createNewPost(post, reqUser.getId());

        return new ResponseEntity<>(creadPost, HttpStatus.ACCEPTED);
    ...
    public ResponseEntity<Post> likPostHandler(
            @RequestHeader("Authorization") String jwt,
            @PathVariable Integer postId) throws Exception {
